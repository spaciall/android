...
public class Stage7 extends Stage {
	...
	boolean ClearStage()
	{
		...
		m_Char = new Char(m_CharMgr, m_CharAni,0, 0, 0, 100, 16);
		m_Char1 = new Char(m_CharMgr, m_CharAni1, 1, 64, 0, 100, 16);
		m_Char2 = new Char(m_CharMgr, m_CharAni2, 2, 128, 0, 100, 16);
		m_Char3 = new Char(m_CharMgr, m_CharAni3, 3, 192, 0, 100, 16);
		m_Char4 = new Char(m_CharMgr, m_CharAni4, 4, 256, 0, 100, 16);
		m_Char5 = new Char(m_CharMgr, m_CharAni5, 5, 0, 64, 100, 16);
		m_Char6 = new Char(m_CharMgr, m_CharAni6, 6, 64, 64, 100, 16);
		m_Char7 = new Char(m_CharMgr, m_CharAni7, 7, 128, 64, 100, 16);
		m_Char8 = new Char(m_CharMgr, m_CharAni8, 8, 192, 64, 100, 16);
		m_Char9 = new Char(m_CharMgr, m_CharAni9, 9, 256, 64, 100, 16);
		m_Char10 = new Char(m_CharMgr, m_CharAni10, 10, 0, 128, 100, 16);
		m_Char11 = new Char(m_CharMgr, m_CharAni11, 11, 64, 128, 100, 16);
	...
	{
		m_StageResultText.Start(150, 200, "Stage7 Start !!", 300, Global.g_StageResultPaint);
		...
		for (int i = 0; i < m_CharMgr.GetSize(); i++) {
			...
			if (chr.GetHP() <= 0) {
				...
				if(m_CharMgr.GetSize() <= 0) {
					// 미션 클리어
					m_StageResultText.Start(150, 200, "Stage7 Clear !!", 300, Global.g_StageResultPaint);
				...
				if (frontChar == chr) {
					...
					ClearStage();
					m_Map.Clear();
					m_StageResultText.Start(150, 200, "Stage7 Failed !!", 300, Global.g_StageResultPaint);
