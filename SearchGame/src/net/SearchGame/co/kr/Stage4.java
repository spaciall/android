...
public class Stage4 extends Stage {
	...
	boolean ClearStage()
	{
		...
		m_Char = new Char(m_CharMgr, m_CharAni,0, 0, 0, 100, 4);
		m_Char1 = new Char(m_CharMgr, m_CharAni1, 1, 64, 0, 100, 4);
		m_Char2 = new Char(m_CharMgr, m_CharAni2, 2, 128, 0, 100, 2);
		m_Char3 = new Char(m_CharMgr, m_CharAni3, 3, 192, 0, 100, 4);
		...
		m_Char7 = new Char(m_CharMgr, m_CharAni7, 7, 128, 64, 100, 4);
		m_Char8 = new Char(m_CharMgr, m_CharAni8, 8, 192, 64, 100, 2);
		m_Char9 = new Char(m_CharMgr, m_CharAni9, 9, 256, 64, 100, 4);
		m_Char10 = new Char(m_CharMgr, m_CharAni10, 10, 0, 128, 100, 2);
		m_Char11 = new Char(m_CharMgr, m_CharAni11, 11, 64, 128, 100, 4);
		m_Char12 = new Char(m_CharMgr, m_CharAni12, 12, 128, 128, 100, 2);
		m_Char13 = new Char(m_CharMgr, m_CharAni13, 13, 192, 128, 100, 4);
		m_Char14 = new Char(m_CharMgr, m_CharAni14, 14, 256, 128, 100, 2);
		m_Char15 = new Char(m_CharMgr, m_CharAni15, 15, 320, 0, 100, 8);
		m_Char16 = new Char(m_CharMgr, m_CharAni16, 16, 320, 64, 100, 2);
		m_Char17 = new Char(m_CharMgr, m_CharAni17, 17, 320, 128, 100, 4);
		m_Char18 = new Char(m_CharMgr, m_CharAni18, 18, 320, 192, 100, 2);
		m_Char19 = new Char(m_CharMgr, m_CharAni19, 19, 0, 192, 100, 4);
		m_Char20 = new Char(m_CharMgr, m_CharAni20, 20, 64, 192, 100, 2);
		m_Char21 = new Char(m_CharMgr, m_CharAni21, 21, 128, 192, 100, 4);
		m_Char22 = new Char(m_CharMgr, m_CharAni22, 22, 192, 192, 100, 2);
	...
	{
		m_StageResultText.Start(150, 200, "Stage4 Start !!", 300, Global.g_StageResultPaint);
		...
		for (int i = 0; i < m_CharMgr.GetSize(); i++) {
			...
			if (chr.GetHP() <= 0) {
				...
				if(m_CharMgr.GetSize() <= 0) {
					// 미션 클리어
					m_StageResultText.Start(150, 200, "Stage4 Clear !!", 300, Global.g_StageResultPaint);
				...
				if (frontChar == chr) {
					...
					ClearStage();
					m_Map.Clear();
					m_StageResultText.Start(150, 200, "Stage4 Failed !!", 300, Global.g_StageResultPaint);
